 ...
 * @author nicolas
 */
public class ParameterInstanceFrac32SMapVSliderView extends ParameterInstanceFrac32SView {

    ParameterInstanceFrac32SMapVSlider parameterInstance;

    ParameterInstanceFrac32SMapVSliderView(ParameterInstanceFrac32SMapVSlider parameterInstance) {
