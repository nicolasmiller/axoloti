...
public class Slick2dRenderer extends BasicGame {
    ...
    private static PatchCanvasGameContainer container;
    ...
    public static PatchCanvasGameContainer getCanvas() {
        try {
                ...
                container.getContainer().setVSync(false);
                container.getContainer().setUpdateOnlyWhenVisible(true);
                container.getContainer().setForceExit(false);
