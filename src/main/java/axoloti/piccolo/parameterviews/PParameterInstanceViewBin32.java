...
public class PParameterInstanceViewBin32 extends PParameterInstanceViewInt32 {
    ...
    public PParameterInstanceViewBin32(ParameterInstanceBin32 parameterInstance, IAxoObjectInstanceView axoObjectInstanceView) {
        super(parameterInstance, axoObjectInstanceView);
    }

    @Override
    public PCheckboxComponent CreateControl() {
        return new PCheckboxComponent(0, 32);
    }
