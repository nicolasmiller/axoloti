...
public class ObjectSearchFrame extends javax.swing.JFrame {
    ...
    public void Launch(Point patchLoc, AxoObjectInstanceViewAbstract o, String searchString) {
        Launch(patchLoc, o, searchString, true);
    }

    public void Launch(Point patchLoc, AxoObjectInstanceViewAbstract o, String searchString, boolean setVisible) {
