 ...
 * @author nicolas
 */
public class AxoObjectInstanceZombieView extends AxoObjectInstanceView {

    AxoObjectInstanceZombie model;

    public AxoObjectInstanceZombieView(AxoObjectInstanceZombie model) {
        super(model);
        this.model = model;
    }
    ...
    public void PostConstructor() {
        ...
        popm_substitute.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                getPatchView().ShowClassSelector(AxoObjectInstanceZombieView.this.getLocation(), AxoObjectInstanceZombieView.this, null);
            }
        });
