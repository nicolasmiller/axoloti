            ...
            if (dragtarget == null) {
                ...
                if (this != c) {
                    if (IoletAbstract.this instanceof InletInstanceView) {
                        getPatchView().getPatchController().disconnect((InletInstanceView) IoletAbstract.this);
                    } else {
                        getPatchView().getPatchController().disconnect((OutletInstanceView) IoletAbstract.this);
                    }
                }
            } else {
                if (this instanceof InletInstanceView) {
                    if (dragtarget instanceof InletInstanceView) {
                        getPatchView().getPatchController().AddConnection(((InletInstanceView) IoletAbstract.this), ((InletInstanceView) dragtarget));
                    } else if (dragtarget instanceof OutletInstanceView) {
                        getPatchView().getPatchController().AddConnection(((InletInstanceView) IoletAbstract.this), ((OutletInstanceView) dragtarget));
                    }
                } else if (this instanceof OutletInstanceView) {
                    if (dragtarget instanceof InletInstanceView) {
                        getPatchView().getPatchController().AddConnection(((InletInstanceView) dragtarget), ((OutletInstanceView) IoletAbstract.this));
                    }
                }
