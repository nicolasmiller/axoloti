...
public class PAttributeInstanceViewComboBox extends PAttributeInstanceViewString {
    ...
    public PAttributeInstanceViewComboBox(AttributeInstanceComboBox attributeInstance, PAxoObjectInstanceView axoObjectView) {
    ...
    public void PostConstructor() {
        ...
        comboBox = new PDropDownComponent(attributeInstance.getDefinition().getMenuEntries(), attributeInstance);
