...
public class PAttributeInstanceViewTextEditor extends PAttributeInstanceViewString {
    ...
    public PAttributeInstanceViewTextEditor(AttributeInstanceTextEditor attributeInstance, PAxoObjectInstanceView axoObjectInstanceView) {
    ...
    public void PostConstructor() {
        ...
        bEdit = new PButtonComponent("Edit");
        addChild(bEdit);
