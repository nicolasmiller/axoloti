 ...
 */
public class PatchFrame extends javax.swing.JFrame implements DocumentWindow, ConnectionStatusListener, PatchFrameFocusListener {
...
//        jScrollPane1.setViewportView(getPatchView().getViewportView().getComponent());
    ...
    public PatchFrame(final PatchController patchController, QCmdProcessor qcmdprocessor) {
     //   PatchFrame.addPatchFrameFocusListener(this);
     //   setOnTop(this);
