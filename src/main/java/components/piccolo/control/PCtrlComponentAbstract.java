...
public abstract class PCtrlComponentAbstract extends PatchPNode {
    ...
    List<ACtrlListener> listenerList = new ArrayList<>();
...
//    }
    ...
    public void setParentAxoObjectInstanceView(IAxoObjectInstanceView axoObjectView) {
