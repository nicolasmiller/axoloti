 ...
 * @author nicolas
 */
public class ParameterInstanceInt32VRadioView extends ParameterInstanceInt32View {

    ParameterInstanceInt32VRadio parameterInstance;

    ParameterInstanceInt32VRadioView(ParameterInstanceInt32VRadio parameterInstance) {
