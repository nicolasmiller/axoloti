 ...
 * @author nicolas
 */
public class ParameterInstanceInt32HRadioView extends ParameterInstanceInt32View {

    ParameterInstanceInt32HRadio parameterInstance;

    ParameterInstanceInt32HRadioView(ParameterInstanceInt32HRadio parameterInstance) {
