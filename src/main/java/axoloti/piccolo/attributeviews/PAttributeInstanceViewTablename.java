...
public class PAttributeInstanceViewTablename extends PAttributeInstanceViewString {
    ...
    public PAttributeInstanceViewTablename(AttributeInstanceTablename attributeInstance, PAxoObjectInstanceView axoObjectInstanceView) {
    ...
    public void PostConstructor() {
        ...
        TFtableName.setBounds(0, 0, d.width, d.height);
