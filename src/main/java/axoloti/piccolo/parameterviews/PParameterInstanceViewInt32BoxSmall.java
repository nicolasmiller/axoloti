...
public class PParameterInstanceViewInt32BoxSmall extends PParameterInstanceViewInt32Box {
    ...
    public PParameterInstanceViewInt32BoxSmall(ParameterInstanceInt32BoxSmall parameterInstance, IAxoObjectInstanceView axoObjectInstanceView) {
    ...
    public PNumberBoxComponent CreateControl() {
        return new PNumberBoxComponent(0.0, getParameterInstance().getMin(), getParameterInstance().getMax(), 1.0, 12, 12);
    }
}
