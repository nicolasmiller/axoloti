...
public class LWJGLTest extends BasicGame {
    ...
    private AxoComponent[][] objs = new AxoComponent[objDim][objDim];
    private ArrayList<Net> nets = new ArrayList<Net>();
    private Net dragNet;

    public LWJGLTest(String gamename) {
        super(gamename);
    }
    ...
    public void init(GameContainer gc) throws SlickException {
        for (int i = 0; i < objDim; i++) {
            for (int j = 0; j < objDim; j++) {
                objs[i][j] = new AxoComponent(gc, 220 * i, 420 * j, 200, 400, this);
    ...
    public void render(GameContainer gc, Graphics g) throws SlickException {
        ...
        g.scale(scale, scale);
        ArrayList<AxoComponent> selected = new ArrayList<AxoComponent>();
        for (int i = 0; i < objDim; i++) {
            for (int j = 0; j < objDim; j++) {
                AxoComponent c = objs[i][j];
    ...
    public static void main(String[] args) {
       ...
       try {
            ...
            LWJGLTest game = new LWJGLTest("Simple Slick Game");
