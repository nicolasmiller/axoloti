...
public class PNetView extends PatchPNode implements INetView {
    ...
    Map<IInletInstanceView, QuadCurve2D.Float> inletCurves = new HashMap<>();
    Map<IOutletInstanceView, QuadCurve2D.Float> outletCurves = new HashMap<>();

    boolean boundsChangedSincePaint = false;
