...
public class Slick2dComponent extends AbstractComponent {

    protected boolean selected = false;
    private Slick2dRenderer canvas;

    private ArrayList<Slick2dComponent> children = new ArrayList<Slick2dComponent>();
    ...
    public Slick2dComponent(GUIContext container, int x, int y,
            int width, int height, Slick2dRenderer canvas) {
        this(container, new Rectangle(x, y, width, height));
        this.canvas = canvas;
    }

    public Slick2dComponent(GUIContext container, Shape shape) {
        super(container);
    ...
    public void render(GUIContext container, Graphics g) {
        ...
        g.fill(area);
        updateImage();
        for (Slick2dComponent child : children) {
            g.pushTransform();
    ...
    public void add(Slick2dComponent c) {
        c.setParent(this);
        this.children.add(c);
    }

    protected Slick2dComponent parent;

    public void setParent(Slick2dComponent parent) {
        this.parent = parent;
    }
}