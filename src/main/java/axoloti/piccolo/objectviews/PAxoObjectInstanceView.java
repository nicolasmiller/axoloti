...
public class PAxoObjectInstanceView extends PAxoObjectInstanceViewAbstract implements ObjectModifiedListener, IAxoObjectInstanceView {
...
//    private final PDragEventHandler eventHandler = new PDragEventHandler() {
//        @Override
//        public void mouseDragged(PInputEvent e) {
//            super.mouseDragged(e);
//            setLocation((int) e.getPosition().getX(), (int) e.getPosition().getY());
    // TODO fix movement quantization
...
//        titleBar.translate(PADDING, PADDING);
//        titleBar.setDrawBackground(true);
//        titleBar.setLayout(HORIZONTAL_CENTERED);
        final PPopupIcon popupIcon = new PPopupIcon();
...
//
    ...
    JPopupMenu CreatePopupMenu() {
        ...
        popm_substitute.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                //TODO fix me
//                getPatchView().ShowClassSelector(PAxoObjectInstanceView.this.getLocation(), PAxoObjectInstanceView.this, null);
            }
        });
            ...
            popm_embed.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent ae) {
                    if (!getPatchView().isLocked()) {
                        ...
                        PAxoObjectInstanceView.this.updateObj();
                    }
                }
            });
