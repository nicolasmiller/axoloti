...
public class PAxoObjectInstanceView extends PAxoObjectInstanceViewAbstract implements IAxoObjectInstanceView {
    ...
    public void PostConstructor() {
        ...
        setLayout(new BoxLayout(this.getProxyComponent(), BoxLayout.PAGE_AXIS));
        ...
        getPatchPCanvas().getSelectionEventHandler().addSelectableParent(titleBar);

        titleBarLabel.addInputEventListener(toolTipEventListener);
        titleBarLabel.setPickable(true);
        ...
        this.addInputEventListener(new PBasicInputEventHandler() {
            ...
            public void mousePressed(PInputEvent e) {
                if (e.isPopupTrigger()) {
                    JPopupMenu popup = CreatePopupMenu();
                    Point popupLocation = PUtils.getPopupLocation(e);
                    popup.show(getPatchPCanvas(), popupLocation.x, popupLocation.y);
                }
            }
    ...
    private final PBasicInputEventHandler toolTipEventListener = new PBasicInputEventHandler() {
        ...
        public void mouseEntered(PInputEvent e) {
            getCanvas().setToolTipText(tooltiptxt);
        }
