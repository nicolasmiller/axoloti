...
public class PAttributeInstanceViewSDFile extends PAttributeInstanceViewString {
    ...
    public PAttributeInstanceViewSDFile(AttributeInstanceSDFile attributeInstance, PAxoObjectInstanceView axoObjectInstanceView) {
    ...
    public void PostConstructor() {
        ...
        Dimension d = new Dimension(128, 22);
        TFFileName.setBounds(0, 0, d.width, d.height);
        addChild(TFFileName);
        ...
        ButtonChooseFile = new PButtonComponent("choose");
