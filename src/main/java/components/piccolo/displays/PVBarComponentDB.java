...
public class PVBarComponentDB extends PDispComponentAbstract {
    ...
    public PVBarComponentDB(double value, double min, double max, IAxoObjectInstanceView axoObjectInstanceView) {
