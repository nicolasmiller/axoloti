 ...
 * @author nicolas
 */
public class AxoObjectInstanceViewAbstract extends JPanel implements ObjectModifiedListener {
    ...
    AxoObjectInstanceViewAbstract(AxoObjectInstanceAbstract model) {
        this.model = model;
    }
