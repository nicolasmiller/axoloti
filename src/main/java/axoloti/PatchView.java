...
public class PatchView implements ModelChangedListener {
    ...
    private void logState() {
        if (false) {
            System.out.println("*** Patch View State ***");
            int i = 0;
            for (AxoObjectInstanceViewAbstract a : objectInstanceViews) {
    ...
    public void modelChanged(boolean updateSelection) {
        ...
        for (Net n : getPatchController().patchModel.getNets()) {
